...
export default function Card(props) {
    ...
    return (
        <div key={course.id} className="relative overflow-hidden min-h-[400px] max-h-[450px] md:w-[30%] sm:mx-1 mx-3 max-w-[400px] bg-gray-700 rounded-md">
            <div>
                ...
                <div>
                    ...
                    <button onClick={copyToClipboard} className="absolute bottom-0 border-t-2 py-2  bg-white text-black mt-5 hover:bg-slate-700 hover:text-white p-1 w-full  pl-0 items-center ">Copy Description</button>
